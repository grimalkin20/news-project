...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Category Permanently Deleted";
}
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,CategoryName,CategoryImage,Description,PostingDate,UpdationDate from  tblcategory where Is_Active=1");
$cnt=1;
...
<td><img src="categoryimage/<?php echo $row['CategoryImage'];?>" width="120" height="70"></td>
