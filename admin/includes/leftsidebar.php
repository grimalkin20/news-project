...
<?php endif;?>
  ...
  <!--<li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Post (Tags) </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-tags.php">Add Tags</a></li>
                                    <li><a href="manage-tags.php">Manage Tags</a></li>
                                </ul>
                            </li> -->

  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Media </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-mediaurl.php">Add Media Link</a></li>
                                    <li><a href="manage-mediaurl.php">Manage Media Link</a></li>
                                </ul>
                            </li>  
  ...
  <!--<li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="add-breakingnews.php">Add BreakingNews</a></li>
                                    <li><a href="manage-breakingnews.php">Manage BreakingNews</a></li>
                                </ul>
                            </li>  -->
