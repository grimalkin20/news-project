        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="https://html.themewant.com/BoundryLine/main/sign-up.php?">
                ...
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="index.php" class="h5 text-none text-gray-900 dark:text-white">
                            <img class="w-32px" src="https://html.themewant.com/BoundryLine/assets/images/common/logo-icon.svg" alt="BoundryLine" data-uc-svg>
                        </a>
                    </div>
                    ...
                    <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                ...
                                <li><a href="https://html.themewant.com/BoundryLine/demo-two/index.php">Classic News</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-three/index.php">Tech</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-four/index.php">Classic Blog</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-five/index.php">Gaming</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-six/index.php">Sports</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-seven/index.php">Newspaper</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-eight/index.php">Magazine</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-nine/index.php">Travel</a></li>
                                <li><a href="https://html.themewant.com/BoundryLine/demo-ten/index.php">Food</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="uc-parent">
                            ...
                            <ul class="uc-nav-sub" data-uc-nav="">
                                <li class="uc-parent">
                                    ...
                                    <ul class="uc-nav-sub">
                                        <li><a href="category.php">Full Width</a></li>
                                ...
                                <li class="uc-parent">
                                    <a href="news-single.php">Blog - detail</a>
                                    <ul class="uc-nav-sub">
                                        <li><a href="news-single.php">Blog detail</a></li>
                ...
                <div class="panel vstack gap-2 md:gap-4 text-center">
                    <div class="panel cstack px-3 lg:px-4 py-4 lg:py-8 m-0 lg:mx-auto">
                        <div class="panel vstack justify-center items-center gap-2 sm:gap-4 text-center">
                            ...
                            <p>Or drop us a message via <a class="uc-link" href="mailto:hello@BoundryLine.co">email</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="sign-in" class="sign-in section panel overflow-hidden">
                <div class="section-outer panel">
                    <div class="section-inner panel">
                        <div class="row child-cols-12 lg:child-cols-6 g-0" data-uc-grid>
                            <div class="d-none lg:d-block">
                                <figure class="panel h-100 m-0 bg-gray-25 dark:bg-gray-900 bg-gray-25 dark:bg-gray-800">
                                    <canvas class="h-100 w-100"></canvas>
                                    <img class="media-cover image" src="assets/images/common/img-fallback.png" data-src="assets/images/demo-seven/common/my-account.jpg" alt="My account" data-uc-img="loading: lazy">
                                </figure>
                            </div>
                            <div>
                                <div class="panel vstack md:items-center justify-center h-screen overflow-hidden">
                                    <div data-anime="targets: >*; translateY: [-24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                        <div class="uc-logo cstack mx-auto mb-6 lg:mb-8">
                                            <a href="index.php">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-none dark:d-block" src="https://html.themewant.com/BoundryLine/assets/images/demo-seven/common/logo-dark.svg" alt="Create an account">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-block dark:d-none" src="https://html.themewant.com/BoundryLine/assets/images/demo-seven/common/logo-light.svg" alt="Create an account">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="panel py-4 px-2">
                                        <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center" data-anime="targets: >*; translateY: [24, 0]; opacity: [0, 1]; easing: easeInOutExpo; duration: 750; delay: anime.stagger(100);">
                                            ...
                                            <div class="hstack gap-2">
                                                <a href="#google" class="btn btn-sm btn-alt-danger w-100 rounded bg-gray-50 dark:bg-gray-800 text-dark dark:text-white">
                                                    <i class="icon icon-1 unicon-logo-google"></i>
                                                </a>
                                                <a href="#facebook" class="btn btn-sm btn-alt-blue-700 w-100 rounded bg-gray-50 dark:bg-gray-800 text-dark dark:text-white">
                                                    <i class="icon icon-1 unicon-logo-facebook"></i>
                                                </a>
                                                <a href="#github" class="btn btn-sm btn-alt-dark w-100 rounded bg-gray-50 dark:bg-gray-800 text-dark dark:text-white">
                                            ...
                                            <div class="panel h-24px">
                                                ...
                                                <span class="position-absolute top-50 start-50 translate-middle px-1 fs-7 fw-medium text-uppercase bg-white dark:bg-black">Or</span>
                                            </div>
                                            <form class="vstack gap-2">
                                                <input class="form-control form-control-sm h-40px w-full fs-6 bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30" type="email" placeholder="Your email" required>
                                                <input class="form-control form-control-sm h-40px w-full fs-6 bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30" type="password" placeholder="Password" autocomplete="new-password" required>
                                                <div class="hstack text-start">
                                                    <div class="form-check text-start">
                                                        <input id="form_accept_terms" class="form-check-input rounded bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30" type="checkbox" required>
                                                        <label for="form_accept_terms" class="hstack justify-between form-check-label fs-6">I read and accept the <a href="page-terms.html" class="uc-link ms-narrow">terms of use</a>. </label>
                                                    </div>
                                                </div>
                                                <button class="btn btn-primary btn-sm mt-1" type="submit">Create my account</button>
                                            </form>
                                            <p>Already have an account? <a class="uc-link" href="sign-in.php">Sign in</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
