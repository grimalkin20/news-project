        ...
        <div id="uc-search-modal" class="uc-modal-full uc-modal" data-uc-modal="overlay: true">
            <div class="uc-modal-dialog d-flex justify-center bg-white text-dark dark:bg-gray-900 dark:text-white" data-uc-height-viewport="">
                ...
                <div class="panel w-100 sm:w-500px px-2 py-10">
                    ...
                    <form class="hstack gap-1 mt-4 border-bottom p-narrow dark:border-gray-700" action="https://html.themewant.com/BoundryLine/main/sign-in.php?">
                                ...
                                <div class="panel vstack md:items-center justify-center h-screen overflow-hidden">
                                    <div data-anime="targets: >*; translateY: [-24, 0]; opacity: [0, 1]; easing: easeInOutCubic; duration: 750; delay: anime.stagger(100);">
                                        <div class="uc-logo cstack mx-auto mb-6 lg:mb-8">
                                            <a href="index.php">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-none dark:d-block" src="https://html.themewant.com/BoundryLine/assets/images/demo-seven/common/logo-dark.svg" alt="Sign in">
                                                <img class="w-100px lg:w-128px text-dark dark:text-white hover:text-primary transition-color duration-150 d-block dark:d-none" src="https://html.themewant.com/BoundryLine/assets/images/demo-seven/common/logo-light.svg" alt="Sign in">
                                            </a>
                                        </div>
                                    </div>
                                            ...
                                            <form class="vstack gap-2">
                                                ...
                                                <div class="hstack justify-between text-start">
                                                    <div class="form-check text-start">
                                                        <input id="form_remember_me" class="form-check-input rounded bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30" type="checkbox">
                                                        <label for="form_remember_me" class="hstack justify-between form-check-label fs-6">Remember me?</label>
                                                    </div>
                                                    <a href="reset-password.php" class="uc-link fs-6">Forgot password</a>
                                                </div>
                                                <button class="btn btn-primary btn-sm mt-1" type="submit">Log in</button>
                                            </form>
                                            <p>Have no account yet? <a class="uc-link" href="sign-up.php">Sign up</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
