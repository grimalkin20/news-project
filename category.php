...
<head>
        ...
        <title>Category - BoundryLine</title>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        ...
                        <li><span class="opacity-50">Category Archive</span></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="container max-w-xl">
                        <div class="section-inner panel vstack gap-3 sm:gap-6 lg:gap-9" data-anime="targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100);">
                            <header class="page-header vstack justify-center items-center gap-2 md:gap-4 text-center max-w-650px mx-auto">
                                <h1 class="h4m-0">Category Archive</h1>
                            </header>
                            <div class="row child-cols-12 sm:child-cols-4 col-match gy-4 sm:gy-6 xl:gy-8 gx-2 xl:gx-4">
        <?php $query=mysqli_query($con,"select id,CategoryName,CategoryImage from tblcategory");
                                    ...
                                    <article class="post type-post panel vstack gap-2">
                                        <div class="post-image panel overflow-hidden">
                                            <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                <img class="media-cover image uc-transition-scale-up uc-transition-opaque" src="assets/images/common/img-fallback.png" data-src="admin/categoryimage/<?php echo htmlentities($row['CategoryImage']);?>" alt="<?php echo htmlentities($row['CategoryName']);?>" data-uc-img="loading: lazy">
                                                <a href="JavaScript:Void(0)" class="position-cover" data-caption="<?php echo htmlentities($row['CategoryName']);?>"></a>
                                            </figure>
                                        </div>
                                        <div class="post-header panel vstack gap-1 lg:gap-2">
                                            <h3 class="post-title h5 xl:h4 m-0 text-center text-truncate-2 m-0">
                                                <a class="text-none" href="sub-category.php?catid=<?php echo htmlentities($row['id'])?>"><?php echo htmlentities($row['CategoryName']);?></a>
                                            </h3>
                                            <div class="actions">
