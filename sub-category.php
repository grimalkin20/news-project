...
<head>
        ...
        <title>Sub-Categories - BoundaryLine</title>
            ...
            <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
                <div class="container max-w-xl">
                    <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                        ...
                        <li><i class="unicon-chevron-right opacity-50"></i></li>
                        <li><span class="opacity-50">Categories</span></li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    <figure class="featured-image m-0 ratio ratio-16x9 rounded uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                                        ...
                                                        <a href="news-single.php" class="position-cover" data-caption="<?php echo htmlentities($row['posttitle']);?>"></a>
                                                    </figure>
                                                    <div class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                        <a class="text-none" href="<?php echo htmlentities($row['id'])?>?category-name=<?php echo (htmlentities($row['category'])); ?>"><?php echo htmlentities($row['category']);?></a>
                                                    </div>
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none" href="news-single.php?nid=<?php echo htmlentities($row['pid']);?>?url_id=<?php echo (strtolower(htmlentities($row['PostUrl']))); ?>"><?php echo htmlentities($row['posttitle']);?></a>
                                                    </h3>
                                                    <div>
                        ...
                        <div class="uc-footer-bottom panel vstack gap-4 justify-center lg:fs-5">
                            <nav class="footer-nav">
                                <ul class="nav-x gap-2 lg:gap-4 justify-center text-center text-uppercase fw-medium">
                                    <li><a class="hover:text-gray-900 dark:hover:text-white duration-150" href="sub-category.php">Politics</a></li>
                                    <li><a class="hover:text-gray-900 dark:hover:text-white duration-150" href="sub-category.php">Opinions</a></li>
                                    <li><a class="hover:text-gray-900 dark:hover:text-white duration-150" href="sub-category.php">World</a></li>
                                    <li><a class="hover:text-gray-900 dark:hover:text-white duration-150" href="sub-category.php">Media</a></li>
                                </ul>
                            </nav>
